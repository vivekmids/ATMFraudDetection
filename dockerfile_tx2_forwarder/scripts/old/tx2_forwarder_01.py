...
local_client_topics = ["faces", "response"]
...
while True:
    ...
    local_client = mqtt.Client("mosquitto_to_forwarder")
    ...
    # Instantiate a Paho MQTT client ('remote_client') and have it connect to my VSI
    # for this assignment at 169.62.97.69
