...
def on_message_remote(client, userdata, msg):
    ...
    if msg.topic == "adjudication/go":
        ...
        local_client.publish("adjudication/usernotfound", payload=msg.payload, qos=2, retain=False)
        print("'adjudication/usernotfound' message published to local client", msg.payload)    
